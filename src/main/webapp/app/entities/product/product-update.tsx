        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('ecommerceApp.product.name')}
                id="product-name"
                name="name"
                data-cy="name"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('ecommerceApp.product.description')}
              ...
              />
              <ValidatedField
                label={translate('ecommerceApp.product.price')}
                id="product-price"
                name="price"
                data-cy="price"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('ecommerceApp.product.quantity')}
                id="product-quantity"
                name="quantity"
                data-cy="quantity"
                type="text"
              ...
              <ValidatedField
                ...
                name="category"
                data-cy="category"
                label={translate('ecommerceApp.product.category')}
                type="select"
              >
                <option value="" key="0" />
                {categories

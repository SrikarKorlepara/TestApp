      ...
      <h2 id="customer-heading" data-cy="CustomerHeading">
        ...
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            ...
            <Translate contentKey="ecommerceApp.customer.home.refreshListLabel">Refresh List</Translate>
          </Button>
        ...
        {customerList && customerList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="ecommerceApp.customer.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="ecommerceApp.customer.home.notFound">No Customers found</Translate>
            </div>
          )
        )}
      </div>

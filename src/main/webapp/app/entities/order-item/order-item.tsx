      ...
      <h2 id="order-item-heading" data-cy="OrderItemHeading">
        ...
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            ...
            <Translate contentKey="ecommerceApp.orderItem.home.refreshListLabel">Refresh List</Translate>
          </Button>
        ...
        {orderItemList && orderItemList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="ecommerceApp.orderItem.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="ecommerceApp.orderItem.home.notFound">No Order Items found</Translate>
            </div>
          )
        )}
      </div>

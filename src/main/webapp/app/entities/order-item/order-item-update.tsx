  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ecommerceApp.orderItem.home.createOrEditLabel" data-cy="OrderItemCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('ecommerceApp.orderItem.quantity')}
              ...
              />
              <ValidatedField
                label={translate('ecommerceApp.orderItem.totalPrice')}
              ...
              <ValidatedField
                ...
                name="product"
                data-cy="product"
                label={translate('ecommerceApp.orderItem.product')}
                type="select"
              >
                <option value="" key="0" />
                {products
              ...
              <ValidatedField
                ...
                name="order"
                data-cy="order"
                label={translate('ecommerceApp.orderItem.order')}
                type="select"
              >
                <option value="" key="0" />
                {orders

...
import static com.myapp.ecommerce.domain.OrderAsserts.*;
...
import com.myapp.ecommerce.service.mapper.OrderMapper;
...
class OrderResourceIT {
    ...
    public static Order createEntity(EntityManager em) {
        Order order = new Order().orderDate(DEFAULT_ORDER_DATE).status(DEFAULT_STATUS).totalAmount(DEFAULT_TOTAL_AMOUNT);
        return order;
    }
    ...
    public static Order createUpdatedEntity(EntityManager em) {
        Order order = new Order().orderDate(UPDATED_ORDER_DATE).status(UPDATED_STATUS).totalAmount(UPDATED_TOTAL_AMOUNT);
        return order;
    }

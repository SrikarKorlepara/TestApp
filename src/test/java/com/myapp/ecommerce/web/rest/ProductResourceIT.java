package com.myapp.ecommerce.web.rest;

import static com.myapp.ecommerce.domain.ProductAsserts.*;
import static com.myapp.ecommerce.web.rest.TestUtil.createUpdateProxyForBean;
import static com.myapp.ecommerce.web.rest.TestUtil.sameNumber;
...
import com.myapp.ecommerce.IntegrationTest;
...
import com.myapp.ecommerce.service.mapper.ProductMapper;
...
class ProductResourceIT {
    ...
    public static Product createEntity(EntityManager em) {
        Product product = new Product().name(DEFAULT_NAME).description(DEFAULT_DESCRIPTION).price(DEFAULT_PRICE).quantity(DEFAULT_QUANTITY);
        return product;
    }
    ...
    public static Product createUpdatedEntity(EntityManager em) {
        Product product = new Product().name(UPDATED_NAME).description(UPDATED_DESCRIPTION).price(UPDATED_PRICE).quantity(UPDATED_QUANTITY);
        return product;
    }
    ...
    void putExistingProduct() throws Exception {
        ...
        updatedProduct.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).price(UPDATED_PRICE).quantity(UPDATED_QUANTITY);
    ...
    void partialUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.description(UPDATED_DESCRIPTION).quantity(UPDATED_QUANTITY);
    ...
    void fullUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).price(UPDATED_PRICE).quantity(UPDATED_QUANTITY);
